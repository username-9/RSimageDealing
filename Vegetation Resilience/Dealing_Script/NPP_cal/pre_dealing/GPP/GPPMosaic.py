...
if __name__ == "__main__":
    # env. building
    os.chdir(r"D:\Data\VegetationResilienceDealing\Integrate_Output\GPP_MOSAIC_OUTPUT")
    ...
    for i in range(len(file_list_check)):
        file_list_check[i] = file_list_check[i][:19]
    ...
    # mosaic
    output_path = r"D:\Data\VegetationResilienceDealing\integrate_out\GPP_MOSAIC_OUTPUT"
