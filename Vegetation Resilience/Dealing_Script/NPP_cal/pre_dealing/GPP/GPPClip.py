...
if __name__ == "__main__":
    work_path = r"D:\Data\VegetationResilienceDealing\Integrate_Output\GPP_INTEGRATE_OUTPUT"
    os.chdir(work_path)
    ...
    output_dir = r"D:\Data\VegetationResilienceDealing\Integrate_Output\GPP_BTH_CLIP"
    for file in file_list:
        ds = raster_read(file)
