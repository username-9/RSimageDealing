...
if __name__ == "__main__":
    work_path = r"D:\Data\VegetationResilienceDealing\Integrate_Output\GPP_MOSAIC_OUTPUT"
    os.chdir(work_path)
    ...
    del ds
    output_dir = r"D:\Data\VegetationResilienceDealing\Integrate_Output\GPP_INTEGRATE_OUTPUT"
