...
if __name__ == "__main__":
    # env. building
    os.chdir(r"D:\Data\VegetationResilienceDealing\Integrate_Output\LAI\LAI_HDF_to_TIFF_OUTPUT")
    ...
    # mosaic
    output_path = r"D:\Data\VegetationResilienceDealing\Integrate_Output\LAI\LAI_MOSAIC_OUTPUT"
