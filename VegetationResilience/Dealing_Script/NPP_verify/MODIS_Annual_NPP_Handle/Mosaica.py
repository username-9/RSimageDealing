...
if __name__ == "__main__":
    # env. building
    os.chdir(r"F:\DATA\Vegetation_Resilience_D_DATA_C\REF_NPP\REF_NPP_ANNUAL\HDF_TO_TIFF")
    ...
    # mosaic
    output_path = r"F:\DATA\Vegetation_Resilience_D_DATA_C\REF_NPP\REF_NPP_ANNUAL\MOSAICA"
