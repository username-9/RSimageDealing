...
if __name__ == "__main__":
    ...
    verify_array = []
    if not os.path.exists(".\\VerifyArray.npy"):
        verify_temp = None
        ...
        np.save(".\\VerifyArray.npy", verify_array)
    else:
        verify_array = np.load(".\\VerifyArray.npy")
    ...
    # plot scatter
    scatter(array_x, array_y, function_format, ci=10)
