...
if __name__ == '__main__':
    ...
    out_dir = r"F:\DATA\Vegetation_Resilience_D_DATA_C\0831_archive\TIME_SERIES_HANDLE\TAC_1_LAG"
    ...
    output_file = os.path.join(out_dir, "tca_1lag.tif")
    detrend_file = r"F:\DATA\Vegetation_Resilience_D_DATA_C\0831_archive\TIME_SERIES_HANDLE\DETREND\detrended.tif"
    ...
    for x_pos, y_pos, x_size, y_size in process_bar:
        ...
        try:
            ...
            for i in tqdm.tqdm(range(merge_ds.RasterCount)):
