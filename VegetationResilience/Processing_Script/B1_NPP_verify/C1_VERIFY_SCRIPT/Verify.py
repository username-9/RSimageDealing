...
if __name__ == "__main__":
    ...
    verify_array = []
    if not os.path.exists("../F_VerifyArray/F_VerifyArray.npy"):
        verify_temp = None
        ...
        np.save("../F_VerifyArray/F_VerifyArray.npy", verify_array)
    else:
        verify_array = np.load("../F_VerifyArray/F_VerifyArray.npy")
