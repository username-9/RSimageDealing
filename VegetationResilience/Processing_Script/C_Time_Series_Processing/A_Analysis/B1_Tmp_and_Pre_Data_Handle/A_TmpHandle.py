# Using for get statist temperature or precipitation into a json file
...
if __name__ == "__main__":
    ...
    json.dump(result_dict, open(r"../F_Analysis_JSON/B1_OUTPUT_S_LUCC_Tmp_1010.json", "w"), indent=4)