...
def para_cal(file):
    ...
    output_dir = r"F:\DATA\Vegetation_Resilience_D_DATA_C\GPP\GPP_INTEGRATE_OUTPUT_MEAN_0830_CLIP"
...
if __name__ == "__main__":
    work_path = r"F:\DATA\Vegetation_Resilience_D_DATA_C\GPP\GPP_INTEGRATE_OUTPUT_MEAN_0830"
    os.chdir(work_path)
