...
if __name__ == "__main__":
    work_path = r"F:\DATA\Vegetation_Resilience_D_DATA_C\0903_archive\NPP\NPP_DAILY_PARACHANGE"
    filelist = workdir_filelist(work_path)
    out_dir = r"F:\DATA\Vegetation_Resilience_D_DATA_C\0903_archive\NPP\NPP_DAILY_VERIFY\V_RESAMPLE"
    # ref tif
    ref = r"F:\DATA\Vegetation_Resilience_D_DATA_C\0831_archive\REF_NPP\NPP_REF\REF_NPP_INTEGRATE_MuSyq\200003.tif"
    gdal.AllRegister()
