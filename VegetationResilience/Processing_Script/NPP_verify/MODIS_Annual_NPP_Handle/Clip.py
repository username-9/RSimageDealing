...
def para_cal(file):
    ...
    output_dir = r"F:\DATA\Vegetation_Resilience_D_DATA_C\REF_NPP\REF_NPP_ANNUAL\CLIP"
...
if __name__ == "__main__":
    work_path = r"F:\DATA\Vegetation_Resilience_D_DATA_C\REF_NPP\REF_NPP_ANNUAL\MOSAICA"
    os.chdir(work_path)
