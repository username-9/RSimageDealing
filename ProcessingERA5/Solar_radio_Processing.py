...
def para_cal(raster, out_dir, _year):
    ...
    array[array != no_data] = array[array != no_data] / 1000000
    ...
    month = month[0]
    out_path = os.path.join(out_dir, "Global_" + _year + '_' + str(month).zfill(2) + "_sol.tif")
...
if __name__ == "__main__":
    ...
    tmp_folder = r"F:\DATA\EAR5\global_ERA-5\global_solar radiation"
    out_dir = r"F:\DATA\EAR5\OUTPUT\solar-radi"
